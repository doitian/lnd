...
type Invoice struct {
	...
	OriginalPaymentRequest string                      `protobuf:"bytes,29,opt,name=original_payment_request,json=originalPaymentRequest,proto3" json:"original_payment_request,omitempty"`
}
...
func (x *Invoice) GetOriginalPaymentRequest() string {
	if x != nil {
		return x.OriginalPaymentRequest
	}
	return ""
}
...
var file_lightning_proto_rawDesc = []byte{
	...
	0x50, 0x61, 0x69, 0x64, 0x4d, 0x73, 0x61, 0x74, 0x22, 0xfd, 0x09, 0x0a, 0x07, 0x49, 0x6e, 0x76,
	...
	0x49, 0x6e, 0x76, 0x6f, 0x69, 0x63, 0x65, 0x53, 0x74, 0x61, 0x74, 0x65, 0x12, 0x38, 0x0a, 0x18,
	0x6f, 0x72, 0x69, 0x67, 0x69, 0x6e, 0x61, 0x6c, 0x5f, 0x70, 0x61, 0x79, 0x6d, 0x65, 0x6e, 0x74,
	0x5f, 0x72, 0x65, 0x71, 0x75, 0x65, 0x73, 0x74, 0x18, 0x1d, 0x20, 0x01, 0x28, 0x09, 0x52, 0x16,
	0x6f, 0x72, 0x69, 0x67, 0x69, 0x6e, 0x61, 0x6c, 0x50, 0x61, 0x79, 0x6d, 0x65, 0x6e, 0x74, 0x52,
	0x65, 0x71, 0x75, 0x65, 0x73, 0x74, 0x1a, 0x4b, 0x0a, 0x0d, 0x46, 0x65, 0x61, 0x74, 0x75, 0x72,
	...
	0x44, 0x5f, 0x50, 0x41, 0x52, 0x41, 0x4d, 0x45, 0x54, 0x45, 0x52, 0x10, 0x04, 0x32, 0xfc, 0x27,
	...
	0x6c, 0x6e, 0x72, 0x70, 0x63, 0x2e, 0x50, 0x61, 0x79, 0x52, 0x65, 0x71, 0x12, 0x41, 0x0a, 0x0f,
	0x41, 0x64, 0x64, 0x49, 0x6e, 0x76, 0x6f, 0x69, 0x63, 0x65, 0x50, 0x72, 0x6f, 0x78, 0x79, 0x12,
	0x13, 0x2e, 0x6c, 0x6e, 0x72, 0x70, 0x63, 0x2e, 0x50, 0x61, 0x79, 0x52, 0x65, 0x71, 0x53, 0x74,
	0x72, 0x69, 0x6e, 0x67, 0x1a, 0x19, 0x2e, 0x6c, 0x6e, 0x72, 0x70, 0x63, 0x2e, 0x41, 0x64, 0x64,
...
var file_lightning_proto_depIdxs = []int32{
	...
	174, // 219: lnrpc.Lightning.AddInvoiceProxy:input_type -> lnrpc.PayReqString
	...
	157, // 288: lnrpc.Lightning.AddInvoiceProxy:output_type -> lnrpc.AddInvoiceResponse
	165, // 289: lnrpc.Lightning.ListPayments:output_type -> lnrpc.ListPaymentsResponse
	168, // 290: lnrpc.Lightning.DeletePayment:output_type -> lnrpc.DeletePaymentResponse
	169, // 291: lnrpc.Lightning.DeleteAllPayments:output_type -> lnrpc.DeleteAllPaymentsResponse
	133, // 292: lnrpc.Lightning.DescribeGraph:output_type -> lnrpc.ChannelGraph
	135, // 293: lnrpc.Lightning.GetNodeMetrics:output_type -> lnrpc.NodeMetricsResponse
	131, // 294: lnrpc.Lightning.GetChanInfo:output_type -> lnrpc.ChannelEdge
	127, // 295: lnrpc.Lightning.GetNodeInfo:output_type -> lnrpc.NodeInfo
	121, // 296: lnrpc.Lightning.QueryRoutes:output_type -> lnrpc.QueryRoutesResponse
	139, // 297: lnrpc.Lightning.GetNetworkInfo:output_type -> lnrpc.NetworkInfo
	141, // 298: lnrpc.Lightning.StopDaemon:output_type -> lnrpc.StopResponse
	143, // 299: lnrpc.Lightning.SubscribeChannelGraph:output_type -> lnrpc.GraphTopologyUpdate
	173, // 300: lnrpc.Lightning.DebugLevel:output_type -> lnrpc.DebugLevelResponse
	179, // 301: lnrpc.Lightning.FeeReport:output_type -> lnrpc.FeeReportResponse
	182, // 302: lnrpc.Lightning.UpdateChannelPolicy:output_type -> lnrpc.PolicyUpdateResponse
	185, // 303: lnrpc.Lightning.ForwardingHistory:output_type -> lnrpc.ForwardingHistoryResponse
	187, // 304: lnrpc.Lightning.ExportChannelBackup:output_type -> lnrpc.ChannelBackup
	190, // 305: lnrpc.Lightning.ExportAllChannelBackups:output_type -> lnrpc.ChanBackupSnapshot
	195, // 306: lnrpc.Lightning.VerifyChanBackup:output_type -> lnrpc.VerifyChanBackupResponse
	193, // 307: lnrpc.Lightning.RestoreChannelBackups:output_type -> lnrpc.RestoreBackupResponse
	190, // 308: lnrpc.Lightning.SubscribeChannelBackups:output_type -> lnrpc.ChanBackupSnapshot
	198, // 309: lnrpc.Lightning.BakeMacaroon:output_type -> lnrpc.BakeMacaroonResponse
	200, // 310: lnrpc.Lightning.ListMacaroonIDs:output_type -> lnrpc.ListMacaroonIDsResponse
	202, // 311: lnrpc.Lightning.DeleteMacaroonID:output_type -> lnrpc.DeleteMacaroonIDResponse
	205, // 312: lnrpc.Lightning.ListPermissions:output_type -> lnrpc.ListPermissionsResponse
	211, // 313: lnrpc.Lightning.CheckMacaroonPermissions:output_type -> lnrpc.CheckMacPermResponse
	212, // 314: lnrpc.Lightning.RegisterRPCMiddleware:output_type -> lnrpc.RPCMiddlewareRequest
	25,  // 315: lnrpc.Lightning.SendCustomMessage:output_type -> lnrpc.SendCustomMessageResponse
	23,  // 316: lnrpc.Lightning.SubscribeCustomMessages:output_type -> lnrpc.CustomMessage
	66,  // 317: lnrpc.Lightning.ListAliases:output_type -> lnrpc.ListAliasesResponse
	21,  // 318: lnrpc.Lightning.LookupHtlcResolution:output_type -> lnrpc.LookupHtlcResolutionResponse
